...
public class PeriodUtils {
    /**
     * Same as {@link #getQuarterDates(int) }, with the year assumed to be this year.
     * @return 
     */
    ...
    /**
     * Same as {@link #getQuarterDates(int) }, with the year assumed to be last year.
     * @return 
     */
    ...
    /**
     * Obtains a Map of {@link YearQuarterDate} for all the quarters of the specified year. 
     * If <code>year</code> value is 0 or less, it is assumed that the year is the current year.
     * @param year
     * @return 
     */
...
//        }        
    ...
    /**
     * Takes the date supplied, and computes the next {@link YearQuarterDate} for it
     * @param currentDate
     * @return 
     */
    ...
    /**
     * Uses the supplied date to compute all the 4 quarters of a year from the date supplied, and sets the "year" field appropriately.
     * 
     * @param currentDate
     * @return 
     */
