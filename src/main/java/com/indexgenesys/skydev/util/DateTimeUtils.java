...
//    private static NumberFormat nf = NumberFormat.getInstance();
    ...
    public static final String TIME_AM_PM = "hh:mm a";
...
//            System.out.println(formatDateShort(checkDate)+ "  " + formatDateShort(endDate));
    ...
    public static boolean isEndOfMonth(Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        return (calendar.get(Calendar.DAY_OF_MONTH) == numberOfDaysInMonth(date));
    }
...
//        Date lastDateOfMonth = dateFormat.parse(d);
    ...
    public static int getAge(Date birthdate) {
        ...
        if (birthdate != null) {
            ...
            LocalDate bday = instant.atZone(defaultZoneId).toLocalDate();
